...
pref("extensions.osext.alerterrors", true);
...
pref("extensions.osext.limitalter", 25);
pref("extensions.osext.abwertungspiele", 36);
pref("extensions.osext.physio", true);
pref("extensions.osext.bilanz", 0);
pref("extensions.osext.neuvertrag", 24);
